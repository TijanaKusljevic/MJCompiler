...
public class Ternarni extends DesignatorStatement {
    ...
    public Ternarni (Designator Designator, Condition Condition, StartIf StartIf, Expr Expr, StartElse StartElse, Expr Expr1, EndElse EndElse) {
